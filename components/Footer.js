...
const Footer = () => {
  return (
    <footer className="mt-auto w-full py-10 px-4 sm:px-6 lg:px-8 mx-auto bg-white shadow-sm ">
      ...
      <div className="text-center">
        ...
        <div className="mt-3">
          <p className="text-gray-500 dark:text-neutral-500">MEKIYA ENTERPRISE</p>
          <p className="text-gray-500 dark:text-neutral-500">©2024. All rights reserved.</p>
        </div>
